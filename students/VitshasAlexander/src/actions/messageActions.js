...
export const DELETE_MESSAGES_BY_CHAT_REQUEST =
  "@@message/DELETE_MESSAGES_BY_CHAT_REQUEST";
export const DELETE_MESSAGES_BY_CHAT_SUCCESS =
  "@@message/DELETE_MESSAGES_BY_CHAT_SUCCESS";
export const DELETE_MESSAGES_BY_CHAT_ERROR =
  "@@message/DELETE_MESSAGES_BY_CHAT_ERROR";
...
export const deleteMessagesByChat = (chatId) => {
  return createAction({
    ...
    types: [
      {
        type: DELETE_MESSAGES_BY_CHAT_REQUEST,
        payload: { id },
      },
      {
        type: DELETE_MESSAGES_BY_CHAT_SUCCESS,
        payload: { id },
      },
